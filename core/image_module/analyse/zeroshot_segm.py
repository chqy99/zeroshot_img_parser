...
if __name__ == "__main__":
    ...
    segmentation_list = [mask['segmentation'] for mask in masks]

    from image_module.tools.color_tools import apply_color_mapping_to_masks, composite_overlap_image
    overlap_img = apply_color_mapping_to_masks(segmentation_list)

    output_img =  composite_overlap_image(image, overlap_img)
    output_img.save('overlap.png')
